package com.onedev.mytemperatureconverter
...
import com.onedev.mytemperatureconverter.ui.theme.MyTemperatureConverterTheme
...
fun GeneralTemperatureInput(
    ...
    Column(modifier) {
        OutlinedTextField(
            value = input,
            label = {
                Text(stringResource(R.string.enter_temperature, scale.scaleName))
            },
            keyboardOptions = KeyboardOptions(
                keyboardType = KeyboardType.Number
            ),
